...
\begin{itemize}
    \item McMaster Engineering students attending events.
\end{itemize}

\paragraph{Secondary Stakeholders:}
\begin{itemize}
    \item MES volunteers and event organizers managing logistics.
    \item MES executives overseeing finances and risk management.
\end{itemize}

\paragraph{Tertiary Stakeholders:}
\begin{itemize}
    \item Sponsors and partners supporting events (interested in visibility, engagement, and smooth execution).
    \item McMaster University administration (indirectly, for compliance and liability via waivers).
\end{itemize}
