...
reflect the specific scope assigned to our team (Team \#12, Streamliners), and
does not represent the entirety of the platform being built across all groups.\\

\noindent Our team will focus on implementing the following core features:

\begin{itemize}
    \item \textbf{Centralized registration and ticketing workflows} for events under our team's responsibility.
    \item \textbf{Secure payment integration using Stripe}, including checkout, verification, and confirmation mechanisms.
    \item \textbf{Role-Based and Feature-Based Access Control (RBAC/FBAC)} specific to the administrative tools our team owns.
    \item \textbf{Bus and table sign-up systems} with real-time capacity management and automatic holds/allocations.
    \item \textbf{Analytics dashboards} related to registrations, capacities, and payments linked to our team's modules.
\end{itemize}
