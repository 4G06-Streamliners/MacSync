...
\begin{itemize}
    \item \textbf{MES Event Attendees (students)}: Use the platform to register, purchase tickets, receive updates,
        and check in.
    \item \textbf{MES Event Organizers/Volunteers}: Use the platform to manage events, track registrations, ticket
     sales and payments, waivers, handle check-ins, and communicate with attendees.
\end{itemize}

\paragraph{Secondary Stakeholders:}
\begin{itemize}
    \item \textbf{MES Executives}: Oversee finances, risk management, and reporting.
\end{itemize}

\paragraph{Tertiary Stakeholders:}
\begin{itemize}
    \item \textbf{Sponsors and partners}: Interested in gaining visibility, engagement, and smooth execution.
    \item \textbf{McMaster University Administration}: Indirectly involved for compliance, liability via waivers,
