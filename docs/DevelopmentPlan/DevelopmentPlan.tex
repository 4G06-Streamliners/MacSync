...
\begin{itemize}
    ...
    \item All members are expected to be on time for meetings and remain present for the duration of the meeting unless an acceptable excuse is presented
...
\begin{itemize}
    ...
    \item All members should respect all ideas and viewpoints without judgement
