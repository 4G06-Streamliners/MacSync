...
\textbf{Name} & \textbf{In} & \textbf{Out} & \textbf{Exceptions} \\
\hline
\texttt{SendNotification} & userID: Str, message: Str, notification\_type: Str & success: bool & NotificationError \\
\texttt{getNotificationHistory} & userID: Str & Notifications: List[Str] & RetrievalError \\
